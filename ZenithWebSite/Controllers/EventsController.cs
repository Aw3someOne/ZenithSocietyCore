...
namespace ZenithWebSite.Controllers
{
    ...
    public class EventsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EventId,StartTime,EndTime,IsActive,ActivityCategoryId")] Event @event)
        {
            @event.CreatorName = User.Identity.Name;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EventId,StartTime,EndTime,CreatorName,CreationDate,IsActive,ActivityCategoryId")] Event @event)
        {
            if (id != @event.EventId)
            {
                return NotFound();
